// UiKitView factory backing `m3u_tv/apple_mpv_view`. Creates a UIView backed
// by an AVSampleBufferDisplayLayer, which mpv's vo=avfoundation driver draws
// into directly (see MpvPlayerCore.attach), and registers the resulting core
// with MpvPlayerPlugin so the method/event channel can find it by `viewId`.
