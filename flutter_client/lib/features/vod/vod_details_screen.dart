...
class _CastRevealSlot extends StatefulWidget {
  const _CastRevealSlot({required this.castRow, this.topPadding = 0});
  ...
  @override
  State<_CastRevealSlot> createState() => _CastRevealSlotState();
}

class _CastRevealSlotState extends State<_CastRevealSlot> {
  ...
  @override
  void didUpdateWidget(_CastRevealSlot oldWidget) {
  ...
  void _startTimer() {
    _timer = Timer(_CastRevealSlot.settleDelay, () {
