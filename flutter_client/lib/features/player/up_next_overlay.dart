...
/// Bottom-right "up next" card shown late in a series episode (at the credits
/// mark, or ~90% in when TheIntroDB has no credits segment). Selecting Play
/// swaps the player to the next episode in place; Dismiss hides it for the
