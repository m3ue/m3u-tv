...
- (NSString *)description {
  return [NSString stringWithFormat:@"WAKELOCKPLUSToggleMessage(enable: %@)", self.enable];
}
@end
...
- (NSString *)description {
  return [NSString stringWithFormat:@"WAKELOCKPLUSIsEnabledMessage(enabled: %@)", self.enabled];
}
@end
