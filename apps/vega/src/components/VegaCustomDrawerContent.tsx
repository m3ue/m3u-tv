import {scaledPixels, colors, safeZones} from '@m3u-tv/shared-ui';
...
import {DrawerNavigationProp} from '@amazon-devices/react-navigation__drawer';
import {DrawerParamList} from '../navigation/types';
import {useMenuContext} from '@m3u-tv/shared-ui';
              ...
              <View
                ...
                <View style={styles.cogIcon}>
                  <Text
                    style={[
                      styles.cogIconText,
                      isFocused && styles.cogIconTextFocused,
                    ]}>
                    ⚙
                  </Text>
                </View>
